export const Services = () => {
  return (
    <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden pb-20">
      {/* <!-- Services --> */}
      ...
      <div className="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
        <div className="bg-white shadow-xl p-6 text-center rounded-xl">
          ...
          <p className="px-4 text-gray-500">
            We take immense pride in our visa services, ensuring honesty and
            ...
            comprehensive support to simplify the visa application experience.
            Rely on us for genuine and attentive visa assistance, focused on
            making your journey abroad a successful and seamless one.
          </p>
        </div>
        <div className="bg-white shadow-xl p-6 text-center rounded-xl">
          <div
