...
export default function AboutUs() {
  return (
    <div className="text-gray-700 overflow-x-hidden" id="about-us">
      {/* <!-- about us --> */}
        ...
        <div className="sm:flex items-center gap-8 sm:space-x-8 mt-14">
          <div className="relative" data-aos="fade-up">
            ...
            <p className="py-5 text-justify">
              ...
              processing services for destinations including the USA, UK,
              Canada, Australia, Denmark, and various European countries. We
              Carefully guide you through every step of the application process,
              ensuring that your documents are in order and your profile stands
              out. In addition, we offer a range of language enhancement
              programs designed to equip you with the skills needed to excel in
              academic and professional settings abroad.
            </p>
          </div>
        </div>
        ...
        <div className="sm:flex flex-row-reverse items-center gap-8 sm:space-x-8 mt-14">
          ...
          >
            ...
            <p className="py-5 lg:pr-32">
              Whether you are preparing for the IELTS exam at a basic or
              advanced level, our tailored courses are structured to improve
              your language proficiency, boost your confidence, and help you
              achieve the scores required by top institutions worldwide.
            </p>
          </div>
          <div
        ...
        <div className="sm:flex items-center gap-8 sm:space-x-8 mt-14">
          <div className="relative" data-aos="fade-down">
            ...
            <p className="py-5 text-justify">
              ...
              student’s journey is unique, which is why we strive to offer
              bespoke guidance and support. Our mission is to empower you with
              the knowledge, skills, and confidence to pursue your academic
              dreams on a global stage.
              <br />
              ...
              today to learn how we can help you unlock the door to
              international study opportunities. Let us be your partner in
              achieving academic excellence and a brighter future.
            </p>
          </div>
        </div>
      </div>
