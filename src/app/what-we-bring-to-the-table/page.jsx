...
export default function WhatWeBringToTheTable() {
  return (
    <div className="text-gray-700 overflow-x-hidden pb-20" id="services">
      {/* <!-- Services --> */}
      ...
      {/* <!-- card --> */}
      <div className="container mx-auto px-4 lg:px-12 max-w-screen-xl">
          ...
          <CarouselContent className="mt-20 mb-6 max-md:flex max-md:flex-col max-md:gap-4">
            ...
            >
              <div className="h-full bg-white shadow-xl max-md:pb-6 md:p-6 text-center rounded-xl">
                ...
                <p className="px-4 text-gray-500 text-justify">
                  We take immense pride in providing exceptional visa services
                  for the <span className="text-yellow-500 font-bold">UK</span>,{" "}
                  ...
                  precision, offering step-by-step guidance to ensure accuracy
                  and compliance with all regulations. Transparency is at the
                  heart of what we do, delivering clear explanations and
                  comprehensive support to simplify your visa application
                  experience. Trust us for genuine, attentive assistance,
            ...
            >
              <div className="h-full bg-white shadow-xl max-md:pb-6 md:p-6 text-center rounded-xl">
                ...
                <p className="px-4 text-gray-500 text-justify">
                  ...
                  are fully prepared to achieve your desired score. For those
                  with limited time, our{" "}
                  <span className="text-yellow-500 font-bold">
                    IELTS Crash Course
                  </span>{" "}
                  ...
                  refine your skills, our expert instructors are here to guide
                  you every step of the way, helping you unlock your full
                  potential and succeed in your IELTS journey.
                </p>
              </div>
            </CarouselItem>
            ...
            >
              <div className="h-full bg-white shadow-xl max-md:pb-6 md:p-6 text-center rounded-xl">
                ...
                <p className="px-4 text-gray-500 text-justify">
                  ...
                  personal growth, academic success, or professional
                  advancement. That’s why we offer a range of English courses
                  tailored to your needs. Our{" "}
                  <span className="text-yellow-500 font-bold">
                    Spoken English Course
                  </span>{" "}
                  focuses on building confidence and fluency in everyday
                  communication, helping you speak naturally and effectively.
                  For those starting their journey, the{" "}
                  <span className="text-yellow-500 font-bold">
                  ...
                  supportive learning environment, we’re here to help you
                  achieve your language goals and unlock new opportunities.
                </p>
              </div>
            </CarouselItem>
            ...
            >
              <div className="h-full bg-white shadow-xl max-md:pb-6 md:p-6 text-center rounded-xl">
                ...
                <p className="px-4 text-gray-500 text-justify">
                  ...
                  documents, creating resumes, and drafting Statements of
                  Purpose (SOPs). We also provide assistance with standardized
                  test preparation and registration. Furthermore, we ensure
                  applications are submitted on time, monitor their progress,
                  and help students prepare for admission interviews.
                </p>
              </div>
            </CarouselItem>
            ...
            >
              <div className="h-full bg-white shadow-xl max-md:pb-6 md:p-6 text-center rounded-xl">
                ...
                <p className="px-4 text-gray-500 text-justify">
                  We provide complimentary counseling services to assist
                  students in navigating the university admission journey. Our
                  skilled counselors deliver tailored guidance, review academic
                  records, explore career aspirations, and suggest appropriate
                  universities and programs. This guidance empowers students to
                  make well-informed choices, paving the way for academic
                  achievement. Begin your journey with our free counseling
                  services.
                </p>
              </div>
            </CarouselItem>
